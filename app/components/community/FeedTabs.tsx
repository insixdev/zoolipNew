    ...
    <div className="w-full -mt-1">
      ...
      <div className="sticky top-20 z-20 bg-rose-50/90 backdrop-blur-sm border-b border-rose-100">
        <div className="flex h-12">
          ...
          >
            {isLoading && activeTab === 'following' ? 'Cargando...' : 'Siguiendo'}
          </button>
        </div>
      </div>
...
export function EmptyFollowingState() {
  return (
    <div className="py-12 text-center">
      <h3 className="text-lg font-medium text-gray-700">Publicaciones de las cuentas que sigues</h3>
      <p className="text-gray-500 mt-2">Cuando sigas a personas, sus publicaciones aparecerán aquí.</p>
