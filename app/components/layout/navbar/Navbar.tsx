...
export default function Navbar({
  ...
  const floatingStyles = floating
    ? "mx-3 mt-1 rounded-2xl backdrop-blur-md shadow-lg border "
    : "";
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${floatingStyles} ${fillStyle} ${className} ${isDarkNav}`}
    >
      <div className="max-w-9xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            {/* Messages and Notifications (only show when user is logged in and not hidden) */}
            {!signButton && !hideNotifications && (
