  ...
  const messages = [
    {
      id: '1',
      sender: 'refugio',
      message: 'Hola! Gracias por tu interés en Luna. ¿Te gustaría conocer más sobre ella?',
      timestamp: '10:15 AM'
    },
    {
      id: '2',
    ...
    },
    {
      id: '3',
      sender: 'refugio',
      message: 'Luna es muy cariñosa y tranquila. Le encanta jugar pero también disfruta de momentos de calma. Es perfecta para familias.',
      timestamp: '10:25 AM'
    },
    {
      id: '4',
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-3 flex-shrink-0">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Comunícate directamente con refugios y veterinarios sobre adopciones</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex min-h-0">
          ...
          <div className="w-80 bg-white border-r border-gray-200 flex flex-col flex-shrink-0">
            <div className="p-3 border-b border-gray-200 flex-shrink-0">
              <h2 className="font-semibold text-gray-900 text-sm">Conversaciones con Refugios</h2>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        <h3 className="font-medium text-gray-900 truncate text-sm">{chat.refugio}</h3>
                        <span className="text-xs text-gray-500">{chat.timestamp}</span>
                      </div>
                      <p className="text-xs text-gray-600 truncate">{chat.lastMessage}</p>
                      <p className="text-xs text-orange-600 mt-1">Sobre: {chat.pet}</p>
                    </div>
                    {chat.unread > 0 && (
          ...
          <div className="flex-1 flex flex-col bg-white min-w-0">
            ...
            <div className="p-3 border-b border-gray-200 flex items-center justify-between flex-shrink-0">
              <div className="flex items-center gap-3">
                ...
                />
                <div>
                  <h3 className="font-medium text-gray-900 text-sm">{chats[0].refugio}</h3>
                  <p className="text-xs text-gray-500">Conversación sobre {chats[0].pet}</p>
                </div>
              </div>
