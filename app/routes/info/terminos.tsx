          ...
          <div className="prose prose-gray max-w-none">
            <section className="mb-10">
              ...
              <p className="text-gray-700 mb-4">
                Bienvenido a Zoolip. Al acceder y utilizar nuestro servicio, aceptas cumplir con estos términos de servicio. Por favor, léelos detenidamente.
              </p>
            </section>
            ...
            <section className="mb-10">
              ...
              <p className="text-gray-700 mb-4">
                Zoolip proporciona una plataforma para compartir y descubrir contenido relacionado con mascotas y animales. Al utilizar nuestro servicio, aceptas:
              </p>
            ...
            <section className="mb-10">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">3. Contenido del Usuario</h2>
              <p className="text-gray-700 mb-4">
                Eres responsable del contenido que publiques en Zoolip. Al compartir contenido, nos otorgas una licencia no exclusiva para mostrarlo en nuestra plataforma.
              </p>
            </section>

            <section className="mb-10">
              <h2 className="text-xl font-semibold text-gray-800 mb-4">4. Privacidad</h2>
              <p className="text-gray-600 mb-4">
                Tu privacidad es importante para nosotros. Consulta nuestra <Link to="/privacidad" className="text-rose-600 hover:underline">Política de Privacidad</Link> para obtener más información sobre cómo manejamos tus datos.
              </p>
            </section>

            <section className="mb-10">
              <h2 className="text-xl font-semibold text-gray-800 mb-4">5. Modificaciones</h2>
            ...
            <section>
              ...
              <p className="text-gray-600">
                Si tienes alguna pregunta sobre estos términos, contáctanos en <a href="mailto:hola@zoolip.com" className="text-rose-600 hover:underline">hola@zoolip.com</a>.
              </p>
            </section>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-6">
              ...
              <Link to="/privacidad" className="text-gray-500 hover:text-rose-600 text-sm transition-colors">Privacidad</Link>
