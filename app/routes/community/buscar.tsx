import { Search, Filter, Users, Heart, MessageCircle, Bookmark } from 'lucide-react';
...
export default function CommunityBuscar() {
  ...
  return (
    <div className="w-full mx-auto md:pl-72 px-6 pt-6 pb-10">
      {/* Barra de búsqueda */}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
                ...
                <div className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500 mt-1">{result.followers} seguidores</p>
                    </div>
                    <button className={`px-6 py-2 rounded-xl font-semibold transition-colors ${
                      result.isFollowing 
                  ...
                  <div className="p-6 pb-4">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{result.username} • {result.timestamp}</p>
                      </div>
                    </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-2xl border border-rose-100 p-6">
            <h3 className="text-lg font-bold text-gray-900 mb-3">Sugerencias para ti</h3>
            <p className="text-sm text-gray-600 mb-4">Descubre nuevos perfiles y contenido relacionado con tus intereses</p>
