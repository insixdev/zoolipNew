import { MessageCircle, Send, Phone, Video, MoreVertical, Search, Users, Heart } from 'lucide-react';
...
export default function CommunityChat() {
  const chats = [
    ...
    },
    {
      ...
      lastMessage: 'Mi perro ya se adaptó perfectamente, gracias por los consejos',
      timestamp: 'Ayer',
      unread: 0,
      online: false,
      type: 'usuario'
  ...
  const messages = [
    {
      id: '1',
      sender: 'other',
      message: 'Hola! Vi que también tienes un Golden Retriever. ¿Cómo ha sido tu experiencia?',
      timestamp: '10:15 AM',
      senderName: 'María'
    },
    {
      id: '2',
      sender: 'user',
      message: '¡Increíble! Son súper cariñosos y fáciles de entrenar. ¿El tuyo es cachorro?',
      timestamp: '10:20 AM'
    },
    {
      id: '3',
      sender: 'other',
      message: 'Sí, tiene 4 meses. Estoy buscando consejos para el entrenamiento básico.',
      timestamp: '10:25 AM',
      senderName: 'María'
    },
    {
      id: '4',
      sender: 'user',
      message: 'Te recomiendo empezar con comandos simples como "siéntate" y "ven aquí". La consistencia es clave.',
      timestamp: '10:30 AM'
    },
    {
      id: '5',
      sender: 'other',
      message: '¡Perfecto! ¿Tienes algún truco especial para que preste atención?',
      timestamp: '10:32 AM',
      senderName: 'María'
    }
  ];
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-3 flex-shrink-0">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">Conecta con otros miembros de la comunidad de amantes de los animales</p>
          </div>
        ...
        <div className="flex-1 flex min-h-0">
          ...
          <div className="w-80 bg-white border-r border-gray-200 flex flex-col flex-shrink-0">
            <div className="p-3 border-b border-gray-200 flex-shrink-0">
              <h2 className="font-semibold text-gray-900 text-sm">Conversaciones Activas</h2>
              <p className="text-xs text-gray-500 mt-1">{chats.length} conversaciones</p>
            </div>
            
            <div className="flex-1 overflow-y-auto">
              {chats.map((chat) => (
                <div key={chat.id} className="p-3 border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        <div className="flex items-center gap-2">
                          <h3 className="font-medium text-gray-900 truncate text-sm">{chat.user}</h3>
            ...
            <div className="p-3 border-b border-gray-200 flex items-center justify-between flex-shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">En línea • Miembro de la comunidad</p>
                </div>
              </div>
